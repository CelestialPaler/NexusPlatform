...
import { Activity, Network, Settings, Moon, Sun, Cpu, Wrench, PlayCircle } from 'lucide-react'
...
function App() {
    ...
    return (
        <div className="flex h-screen w-screen bg-gray-900 text-white transition-colors duration-300">
            ...
            <div className="flex-1 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 flex flex-col overflow-hidden transition-colors duration-300">
                {!isStandalone && (
